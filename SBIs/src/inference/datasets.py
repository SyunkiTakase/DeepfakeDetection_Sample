...
def init_ff(dataset='all',phase='test'):
	...
	original_path='/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/FaceForensics++/original_sequences/youtube/raw/videos/'
	folder_list = sorted(glob(original_path+'*'))

	list_dict = json.load(open(f'/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/FaceForensics++/{phase}.json','r'))
	filelist=[]
	for i in list_dict:
		filelist+=i
	...
	folder_list=[]
	for fake in fakes:
		fake_path=f'/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/FaceForensics++/manipulated_sequences/{fake}/raw/videos/'
...
def init_dfdc():
	...
	label=pd.read_csv('/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/DFDC/labels.csv',delimiter=',')
	folder_list=[f'/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/DFDC/videos/{i}' for i in label['filename'].tolist()]
...
def init_dfdcp(phase='test'):
	...
	with open('/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/DFDCP/dataset.json') as f:
		df=json.load(f)
	fol_lab_list_all=[[f"/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/DFDCP/{k.split('/')[0]}/videos/{k.split('/')[-1]}",df[k]['label']=='fake'] for k in df if df[k]['set']==phase_integrated[phase]]
	...
	folder_list=glob('/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/DFDCP/method_*/videos/*/*/*.mp4')+glob('/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/DFDCP/original_videos/videos/*/*.mp4')
...
def init_ffiw():
	...
	path='/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/FFIW10K-v1/FFIW10K-v1-release/'
...
def init_cdf():
	...
	video_list_txt='/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/Celeb-DF-v2/List_of_testing_videos.txt'
	with open(video_list_txt) as f:
		...
		for data in f:
			...
			# print(line)
			path=line[1].split('/')
			folder_list+=['/media/tr22008/8e2435dd-0595-4145-bfff-6c1a049dfde41/Celeb-DF-v2/'+path[0]+'/videos/'+path[1]]
